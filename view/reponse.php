<?php
include '../control/reponseController.php';
        ...
        <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th onclick="sortTable(4)">Avis <span id="sortIcon4"></span></th>
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <td>
                        <span>
                            ...
                            for ($i = 0; $i < $filledStars; $i++) {
                                echo '<i class="fa fa-star fullStar"></i>';
                            }
                            // Output empty stars
                            for ($i = 0; $i < $emptyStars; $i++) {
                                echo '<i class="fa fa-star emptyStar"></i>';
                            }
                            ?>
                        </span>
                    </td>
                <?php
                    echo "<td><a href='./addAvis.php?idRep={$reclam['id']}'>Ajouter Un Avis</a></td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
