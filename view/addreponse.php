...
if (
    ...
    if (
        ...
        $reponseController->addreponse($reponse,$idReclam);
        ...
        <div class="block text-center">
            ...
            <form class="text-left clearfix" action="" method="POST" id="myForm">
                <div class="form-group">
                    ...
                    <input disabled class="form-control" placeholder="Id de Reclam" type="text" id="idreclaamtion" name="idreclamation" value=<?php echo $_GET['idReclam']; ?> />
